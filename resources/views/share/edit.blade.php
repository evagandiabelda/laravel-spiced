...
@section('content')
    ...
    <div class="w-full flex flex-col items-center px-52">
        ...
        <div class="w-full flex flex-col p-16 border-b border-b-[#b0aaaa]">
            <h1 class="text-4xl font-bold mb-6">Editar Share</h1>
            <p>Modifica cualquier dato de tu Share.</p>
        </div>

        <!-- Contenido -->
        <div class="w-full flex flex-col p-16">

            <form action="{{ route('shares.update', $share->id) }}" method="POST" enctype="multipart/form-data" class="flex flex-row justify-between gap-16">
            @csrf
                ...
                <div class="w-1/2 flex flex-col gap-8">
                    ...
                    <div>
                        ...
                        <select id="spices" name="spices[]" multiple
                            class="w-full mt-2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400">
                    ...
                    <div>
                        ...
                        <input type="text" id="img_principal" name="img_principal" placeholder="URL" value="{{ old('img_principal', $share->img_principal) }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="img_secundaria" name="img_secundaria" placeholder="URL" value="{{ old('img_secundaria', $share->img_secundaria) }}"
                            class="w-full mt-2 p-2 border border-gray-300 rounded-lg">
                    </div>
                ...
                <div class="w-1/2 flex flex-col gap-8">
                    ...
                    <div>
                        ...
                        <input type="text" id="titulo" name="titulo" value="{{ old('titulo', $share->titulo) }}"
                            class="w-full mt-2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="texto" name="texto" rows="13"
                            class="w-full mt-2 p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-400">{{ old('texto', $share->texto) }}</textarea>
                    </div>
